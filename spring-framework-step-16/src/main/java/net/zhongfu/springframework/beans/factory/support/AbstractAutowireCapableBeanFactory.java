...
//            }
//
//            // 第14章新增 在设置 Bean 属性之前，允许 BeanPostProcessor 修改属性值
...
//    }
    ...
    protected Object doCreateBean(String beanName, BeanDefinition beanDefinition, Object[] args) {
        ...
        try {
            ...
            // 第16章新增 处理循环依赖，将实例化后的Bean对象提前放入缓存中暴露出来
            if (beanDefinition.isSingleton()) {
        ...
        // 第7章，新增 注册实现了 DisposableBean 接口的 Bean 对象
        registerDisposableBeanIfNecessary(beanName, bean, beanDefinition);
        // 注册到单例，做缓存，方便下次使用
        // registerSingleton(beanName, bean);
        // 第9章 判断 SCOPE_SINGLETON、SCOPE_PROTOTYPE
        // 第16章 判断 SCOPE_SINGLETON、SCOPE_PROTOTYPE
    ...
    /**
     * 第15章新增 Bean 实例化后对于返回 false 的对象，不在执行后续设置 Bean 对象属性的操作
     *
     * @param beanName
     * @param bean
     * @return
